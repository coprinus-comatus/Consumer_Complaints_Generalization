...
## TESTING
Once you downloaded the project and the dataset, as described in the previous section, you can test the solution. To do so, hover your mouse curson over the "test" folder icon and now you can choose:
